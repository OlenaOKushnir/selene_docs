...
html_sidebars = {
	'index': ['sidebarintro.html', 'sourcelink.html', 'localtoc.html','searchbox.html'],
    '**':    ['sidebarintro.html', 'sourcelink.html', 'globaltoc.html','searchbox.html']
}
...
# Example of additional CSS files (where tuple for tag attributes)
# html_css_files = ['custom.css',
#                   'https://example.com/css/custom.css',
#                   ('print.css', {'media': 'print'})]


# Example of adding Custom JS (tuple script tag with attributes)
# html_js_files = ['script.js',
#                  'https://example.com/scripts/custom.js',
#                  ('custom.js', {'async': 'async'})]
html_js_files = [
    ('js/gh-profile-card-v3.1.0.min.js', {'type': 'text/javascript'}),
]
